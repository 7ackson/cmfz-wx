    ...
    <script type="text/javascript">
        ...
        $(function() {
            ...
            $("#captchaImage").click(function () {//点击更换验证码
                var ss =new Date();
                $("#captchaImage").prop("src","${pageContext.request.contextPath }/defaultKaptcha?id="+ss.getTime());
            });
        });
    ...
    <form id="loginForm" action="../back/index.html" method="post" >
        ...
        <table>
            ...
            <tr>
                ...
                <th>&nbsp;</th>
                <td>
                    <input type="button" class="homeButton" value="" onclick="location.href='/'"><input type="button" onclick="doLogin()" class="loginButton" value="登录">
                </td>
            </tr>
            </tbody></table>
